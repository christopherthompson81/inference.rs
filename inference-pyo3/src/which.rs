...
impl From<SpeechLoaderType> for inference_core::SpeechLoaderType {
    fn from(value: SpeechLoaderType) -> Self {
        match value {
            SpeechLoaderType::Dia => inference_core::SpeechLoaderType::Dia,
        }
    }
}
...
impl From<IsqOrganization> for inference_core::IsqOrganization {
    fn from(value: IsqOrganization) -> Self {
        match value {
            IsqOrganization::Default => inference_core::IsqOrganization::Default,
            IsqOrganization::MoQE => inference_core::IsqOrganization::MoeExpertsOnly,
        }
    }
}
