...
use inference_core::{
    ...
    LoraAdapterSpec, LoraRuntimeConfig, MemoryGpuConfig, InferenceRs, InferenceRsBuilder,
    InferenceRsError, MtpConfig, MtpRuntimeConfig, MultimodalLoaderBuilder, MultimodalSpecificConfig,
