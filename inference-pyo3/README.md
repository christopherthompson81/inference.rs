...
`inference` is the Python SDK for [inference.rs](https://github.com/EricLBuehler/mistral.rs), a blazing-fast LLM inference engine.
...
```bash
pip install inference-rs        # CPU, or Metal on Apple Silicon
```
