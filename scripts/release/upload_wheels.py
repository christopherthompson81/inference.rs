...
Usage:
    python scripts/release/upload_wheels.py ./wheels --dry-run       # Verify
    python scripts/release/upload_wheels.py ./wheels --test          # TestPyPI
    python scripts/release/upload_wheels.py ./wheels --token $TOKEN  # PyPI
"""
...
Examples:
  ...
  python scripts/release/upload_wheels.py ./wheels

  # Upload to TestPyPI first
  python scripts/release/upload_wheels.py ./wheels --test

  # Dry run to see what would be uploaded
  python scripts/release/upload_wheels.py ./wheels --dry-run

  # Provide token explicitly
  python scripts/release/upload_wheels.py ./wheels --token pypi-xxx

  # Upload specific packages only
  python scripts/release/upload_wheels.py ./wheels -p inference_rs
        """,
    )
