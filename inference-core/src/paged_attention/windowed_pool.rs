...
const WINDOWED_KV_SLOTS_USED_METRIC: &str = "inference_windowed_kv_slots_used";
const WINDOWED_KV_SLOTS_TOTAL_METRIC: &str = "inference_windowed_kv_slots_total";
...
impl WindowedKvPool {
    ...
    fn copy_pool_slot_cuda(&mut self, source_slot: usize, destination_slot: usize) -> Result<()> {
        ...
        inference_paged_attn::copy_blocks(key_layers, value_layers, &block_mapping)
    }
