...
///
/// ```rust,no_run
/// use inference_mcp::transport::{HttpTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
...
impl HttpTransport {
    ...
    ///
    /// ```rust,no_run
    /// use inference_mcp::transport::HttpTransport;
    /// use std::collections::HashMap;
    ///
...
///
/// ```rust,no_run
/// use inference_mcp::transport::{ProcessTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
/// async fn main() -> anyhow::Result<()> {
...
impl ProcessTransport {
    ...
    ///
    /// ```rust,no_run
    /// use inference_mcp::transport::ProcessTransport;
    /// use std::collections::HashMap;
    ///
    /// #[tokio::main]
    /// async fn main() -> anyhow::Result<()> {
...
///
/// ```rust,no_run
/// use inference_mcp::transport::{WebSocketTransport, McpTransport};
/// use std::collections::HashMap;
///
/// #[tokio::main]
/// async fn main() -> anyhow::Result<()> {
...
impl WebSocketTransport {
    ...
    ///
    /// ```rust,no_run
    /// use inference_mcp::transport::WebSocketTransport;
    /// use std::collections::HashMap;
    ///
    /// #[tokio::main]
    /// async fn main() -> anyhow::Result<()> {
