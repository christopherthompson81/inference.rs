...
use inference_core::{
    Constraint, DiffusionGenerationParams, ImageGenerationResponse, InferenceRs, NormalRequest,
...
pub fn match_responses(
    ...
    match response {
        ...
        Response::CompletionModelError(m, _) => {
            InferenceRs::maybe_log_error(state, &crate::handler_core::ModelErrorMessage(m));
