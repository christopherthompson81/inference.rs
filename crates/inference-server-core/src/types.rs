...
use inference_core::{InferenceRs, Pipeline};

/// This is the underlying instance of inference.rs.
pub type SharedInferenceRsState = Arc<InferenceRs>;

/// This is the `SharedInferenceRsState` that has been extracted for an axum handler.
...
/// use inference_server_core::types::OnChunkCallback;
///
...
/// ```no_run
/// use inference_core::ChatCompletionChunkResponse;
/// use inference_server_core::types::OnDoneCallback;
///
