...
use inference_nn::{
    amoe, attention, cuda, device_map, flashinfer, gdn, kv_cache, lora, metal, mla, model, moe,
    ops, paged_attention, perf_flags, sampler, topology, utils,
};
...
impl InferenceRs {
    ...
    fn resolve_alias_or_default(&self, model_id: Option<&str>) -> Result<String, InferenceRsError> {
        match model_id {
