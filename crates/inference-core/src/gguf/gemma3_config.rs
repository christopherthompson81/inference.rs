...
fn normalize_external_text_config(config: &str, vocab_size: usize) -> Result<JsonValue> {
    ...
    text.insert(
        "_inference_use_language_model_prefix".to_string(),
...
fn synthesize_text_config(
    ...
    Ok(json!({
        "_inference_use_language_model_prefix": GEMMA3_MULTIMODAL_LAYER_COUNTS.contains(&num_hidden_layers),
...
mod tests {
    ...
    fn synthesizes_projectorless_gemma3_1b_config() {
        ...
        assert_eq!(value["_inference_use_language_model_prefix"], false);
