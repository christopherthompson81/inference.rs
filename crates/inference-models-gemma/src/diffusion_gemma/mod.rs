...
pub use config::DiffusionGemmaConfig;
...
impl SelfConditioning {
    fn new(
        ...
        let gate_proj = inference_quant::linear_no_bias(
            hidden_size,
            intermediate_size,
            &None,
            vb.pp("gate_proj"),
        )?;
        let up_proj = inference_quant::linear_no_bias(
            hidden_size,
            intermediate_size,
            &None,
            vb.pp("up_proj"),
...
impl crate::model::MultimodalModel for DiffusionGemmaModel {
    fn forward(
        ...
        let args = model_specific_args
            .downcast::<crate::gemma4::Gemma4SpecificArgs>()
    ...
    fn default_model_specific_args(&self, _input_ids: &Tensor) -> Box<dyn std::any::Any> {
        Box::new(crate::gemma4::Gemma4SpecificArgs::default())
    }
