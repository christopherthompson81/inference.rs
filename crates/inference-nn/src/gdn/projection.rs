...
impl GdnProjection {
    ...
    pub fn core_projection(&self) -> GdnCoreProjection {
        GdnCoreProjection {
            b: self.b.clone(),
            a: self.a.clone(),
    ...
    pub fn gather_core_token_ranges(&self, ranges: &[Range<usize>]) -> Result<GdnCoreProjection> {
