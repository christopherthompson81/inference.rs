...
pub const CUDA_GRAPH_CONTEXT_BUCKET_MIN_TOKENS: usize = 512;
pub const CUDA_GRAPH_DECODE_CONTEXT_FLOOR_TOKENS: usize = 2048;

pub fn cuda_graph_context_bucket_tokens(
...
pub fn cuda_graph_block_table_len_with_cap(
    blocks: usize,
    block_size: usize,
...
pub fn make_block_table_tensor<T: BlockTableRows + ?Sized>(
    rows: &T,
    max_len: usize,
) -> Result<Tensor> {
...
impl PagedAttentionInputMetadata {
    pub fn is_decode_step(&self) -> bool {
        !self.is_first_prompt_chunk && self.query_lens.is_none()
    }

    pub fn has_host_staged_decode_tensors(&self) -> bool {
    ...
    pub fn materialize_decode_tensors(&self) -> Result<Self> {
    ...
    pub fn for_reduced_prefill_queries(
        &self,
        devices: &[Device],
...
pub struct DecodePagedRows {
    ...
    pub block_tables: BlockTableSnapshot,
...
pub struct PagedDecodeMetadataRequirements {
...
pub struct DecodePagedRowsGraphKey {
    batch_size: usize,
    query_len: usize,
    block_size: usize,
...
pub struct DecodeViewHostTensors {
...
#[derive(Default)]
pub struct DecodeViewDeviceMaps {
...
impl DecodePagedRows {
    ...
    #[cfg(feature = "cuda")]
    pub fn full_block_table(&self, row: usize) -> &[usize] {
        self.block_tables.row(row)
    }

    pub fn materialized_block_tables(&self) -> Vec<Vec<usize>> {
    ...
    pub fn build_graph_staged(self: &Arc<Self>) -> Result<PagedAttentionInputMetadata> {
