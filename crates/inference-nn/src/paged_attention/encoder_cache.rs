...
const ENCODER_CACHE_RESIDENT_ENTRIES_METRIC: &str = "inference_encoder_cache_resident_entries";
const ENCODER_CACHE_RESIDENT_LOGICAL_BYTES_METRIC: &str =
    "inference_encoder_cache_resident_logical_bytes";
const ENCODER_CACHE_EVICTIONS_METRIC: &str = "inference_encoder_cache_evictions_total";
const ENCODER_CACHE_INSERT_REJECTIONS_METRIC: &str =
    "inference_encoder_cache_insert_rejections_total";
const ENCODER_CACHE_INTRA_BATCH_DEDUPLICATIONS_METRIC: &str =
    "inference_encoder_cache_intra_batch_deduplications_total";
...
pub struct EncoderCacheBatchLookup {
...
impl EncoderCacheBatchLookup {
    ...
    pub fn uncached(item_count: usize) -> Self {
        Self {
    ...
    pub fn miss_groups(&self) -> &[Vec<usize>] {
        &self.miss_groups
    }

    pub fn resolve_miss(&mut self, miss_idx: usize, outputs: Vec<Tensor>) {
