...
impl DeviceMappedMask {
    /// Build a device-mapped mask from an [`AttentionMask`](crate::attention::AttentionMask).
    ...
    /// Look up the [`AttentionMask`](crate::attention::AttentionMask) for the given device.
