...
#[cfg(feature = "cuda")]
pub fn cuda_topk_logits_packed_batched(
    input: &Tensor,
    k: usize,
...
#[cfg(feature = "cuda")]
pub fn cuda_topk_logits_packed_batched_with_workspace(
    input: &Tensor,
    k: usize,
    inverse_temperatures: &Tensor,
...
#[cfg(feature = "cuda")]
pub fn cuda_topk_ranked_packed_batched(input: &Tensor, k: usize) -> Result<RankedTopKPackedOutput> {
    let mut workspace = None;
    cuda_topk_ranked_packed_batched_with_workspace(input, k, &mut workspace)
}

#[cfg(feature = "cuda")]
pub fn cuda_topk_ranked_packed_batched_with_workspace(
    input: &Tensor,
    k: usize,
...
#[cfg(feature = "cuda")]
pub fn cuda_topk_logits_f32_packed_batched(
    input: &Tensor,
    k: usize,
    inverse_temperatures: &Tensor,
) -> Result<TopKLogitsPackedOutput> {
...
#[cfg(feature = "cuda")]
pub struct RankedTopKPackedOutput {
