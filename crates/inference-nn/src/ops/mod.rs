...
#[cfg(feature = "cuda")]
pub const CUDA_TOPK_MAX_EXACT_PACKED_VOCAB: usize = (1 << 24) + 1;
#[cfg(feature = "cuda")]
const CUDA_TOPK_MAX_GRID_Y: usize = 65_535;
#[cfg(feature = "cuda")]
pub const CUDA_TOPK_MAX_K: usize = 128;
#[cfg(feature = "cuda")]
const CUDA_TOPK_MAX_STAGE2_CANDIDATES: usize = 47 * 1024;
#[cfg(feature = "cuda")]
pub const CUDA_CATEGORICAL_PACKED_WIDTH: usize = 2;
#[cfg(feature = "cuda")]
pub const CUDA_TOP1_PACKED_WIDTH: usize = 2;
#[cfg(feature = "cuda")]
pub const CUDA_TOP1_INVALID_TOKEN: u32 = u32::MAX;
#[cfg(feature = "cuda")]
const CUDA_ASYNC_TOKEN_RING_SLOTS: usize = 2;
#[cfg(feature = "cuda")]
const CUDA_TOPK_SAMPLING_PARAM_WIDTH: usize = 5;
#[cfg(feature = "cuda")]
pub const CUDA_DFLASH_SELECTOR_MAX_K: usize = 128;
...
#[cfg(feature = "cuda")]
pub fn cuda_topk_ranked_packed_max_k(vocab: usize) -> Option<usize> {
