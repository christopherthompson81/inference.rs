...
#[cfg(feature = "cuda")]
pub fn cuda_categorical_logits_f32_packed_batched(
    input: &Tensor,
...
impl CudaTop1Submission {
    #[cfg(test)]
    pub fn device_tokens(&self) -> &Tensor {
...
#[cfg(feature = "cuda")]
pub struct CudaTop1Completion<'a> {
    token_ids: &'a [u32],
    packed: Option<&'a [f32]>,
}
...
impl<'a> CudaTop1Completion<'a> {
    ...
    pub fn packed(&self) -> Option<&'a [f32]> {
        self.packed
    }
}
...
#[cfg(feature = "cuda")]
pub fn cuda_top1_logits_submit_batched(
    input: &Tensor,
    cache: &mut Option<CudaTop1LogitsWorkspace>,
) -> Result<CudaTop1Submission> {
...
#[cfg(feature = "cuda")]
pub fn cuda_top1_logits_submit_batched_packed(
    input: &Tensor,
    cache: &mut Option<CudaTop1LogitsWorkspace>,
) -> Result<CudaTop1Submission> {
...
#[cfg(feature = "cuda")]
pub fn cuda_top1_logits_submit_batched_into(
    input: &Tensor,
...
#[cfg(feature = "cuda")]
pub fn cuda_top1_submission_complete<'a>(
...
#[cfg(feature = "cuda")]
pub fn cuda_top1_submission_cancel(
    workspace: &mut CudaTop1LogitsWorkspace,
    submission: &CudaTop1Submission,
) -> Result<()> {
...
#[cfg(feature = "cuda")]
#[cfg(test)]
pub fn cuda_top1_logits_f32_packed_batched_cached(
    input: &Tensor,
    cache: &mut Option<CudaTop1LogitsWorkspace>,
...
#[cfg(feature = "cuda")]
pub struct CategoricalLogitsPackedOutput {
