...
#[cfg(all(feature = "cuda", target_family = "unix"))]
pub const FA3_DECODE_NUM_SPLITS: usize = 32;
#[cfg(all(feature = "cuda", target_family = "unix"))]
...
#[cfg(all(feature = "cuda", target_family = "unix"))]
pub const FA3_DECODE_MAX_QUERY_LEN: usize = inference_paged_attn::FA3_DECODE_MAX_QUERY_LEN;

#[cfg(all(feature = "cuda", target_family = "unix"))]
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
pub enum Fa3DecodeView {
    Logical,
}

#[cfg(all(feature = "cuda", target_family = "unix"))]
#[derive(Clone, Copy, Debug, Hash, PartialEq, Eq)]
pub struct Fa3DecodeScheduleKey {
...
pub struct Fa3PagedScheduleShape {
    pub device: DeviceLocation,
    pub view: Fa3DecodeView,
    pub batch: usize,
    pub query_len: usize,
...
impl Fa3PagedScheduleShape {
    pub fn prefill_schedule_key(self, num_sm: usize) -> Option<Fa3DecodeScheduleKey> {
    ...
    pub fn decode_schedule_key(self) -> Option<Fa3DecodeScheduleKey> {
...
impl Fa3DecodeScheduleKey {
    pub fn total_q(&self) -> Option<usize> {
...
pub struct Fa3PrefillPoolBytes {
...
#[cfg(all(feature = "cuda", target_family = "unix"))]
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub struct Fa3PrefillWorkspaceBytes {
...
impl Fa3PrefillWorkspaceBytes {
    pub fn pool(self) -> Fa3PrefillPoolBytes {
        self.pool
    }
...
#[cfg(all(feature = "cuda", target_family = "unix"))]
pub fn fa3_prefill_workspace_components(
    batch: usize,
    query_len: usize,
    q_heads: usize,
    kv_heads: usize,
...
pub struct Fa3DecodeState {
    schedules: HashMap<Fa3DecodeScheduleKey, Fa3DecodeBuffers>,
}

#[cfg(all(feature = "cuda", target_family = "unix"))]
impl Fa3DecodeState {
    pub fn insert(&mut self, key: Fa3DecodeScheduleKey, buffers: Fa3DecodeBuffers) {
        self.schedules.insert(key, buffers);
    }

    pub fn get(&self, key: &Fa3DecodeScheduleKey) -> Option<&Fa3DecodeBuffers> {
        self.schedules.get(key)
    }

    pub fn schedules(&self) -> impl Iterator<Item = (&Fa3DecodeScheduleKey, &Fa3DecodeBuffers)> {
        self.schedules.iter()
    }
...
impl FlashInferPagedAttentionViews {
    ...
    #[cfg(all(feature = "cuda", target_family = "unix"))]
    pub fn fa3_view(&self, view: Fa3DecodeView) -> &FlashInferPagedAttentionView {
        match view {
...
impl FlashInferMetadata {
    #[cfg(feature = "cuda")]
    pub fn track_decode_tile_plan(mut self) -> Self {
        self.decode_tile_plan_used = Some(Arc::new(AtomicBool::new(false)));
        self
    }

    #[cfg(feature = "cuda")]
    pub fn decode_tile_plan_was_used(&self) -> bool {
    ...
    #[cfg(all(feature = "cuda", target_family = "unix"))]
    pub fn fa3_decode_buffers(&self, key: &Fa3DecodeScheduleKey) -> Option<&Fa3DecodeBuffers> {
        self.fa3_decode.as_ref()?.get(key)
    }

    #[cfg(all(feature = "cuda", target_family = "unix"))]
    pub fn for_each_fa3_decode_schedule(
        &self,
