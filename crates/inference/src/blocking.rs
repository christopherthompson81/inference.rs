//! Synchronous (blocking) wrappers for the inference SDK.
//!
...
//! use inference::{IsqBits, TextModelBuilder, TextMessages, TextMessageRole};
//!
...
/// ```no_run
/// # use inference::blocking::{BlockingModel, BlockingStream};
/// # use inference::*;
