...
kernel paths stay behind `INFERENCE_RS_DEEPGEMM_ENABLE_LEGACY_DIAGNOSTICS` for
...
provenance and license terms. Files carrying a inference.rs modification notice
...
`INFERENCE_RS_DEEPGEMM_PDL=0` is available for diagnostic comparison.
