...
fn main() -> Result<()> {
    ...
    let out_file = if target.contains("msvc") {
        // Windows case
        out_dir.join("inferencepagedattention.lib")
    } else {
    ...
    if using_fa3_fp8_paged {
        ...
        fa3_builder
            .build_lib(prepare_cuda_archive(out_dir.join("libinferencefa3paged.a")))
...
fn main() -> Result<(), String> {
    ...
    inference_metal_compile::compile_metallibs(&PAGED_ATTENTION_METAL_SOURCE_SET)
}
