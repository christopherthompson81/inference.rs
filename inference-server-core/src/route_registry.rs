...
pub const LOAD_LORA_ADAPTER_ROUTE: RouteInfo =
    RouteInfo::new("/v1/load_lora_adapter", "POST", RouteKind::InferenceRs);
pub const UNLOAD_LORA_ADAPTER_ROUTE: RouteInfo =
    RouteInfo::new("/v1/unload_lora_adapter", "POST", RouteKind::InferenceRs);
pub const LIST_LORA_ADAPTERS_ROUTE: RouteInfo =
    RouteInfo::new("/v1/lora_adapters", "GET", RouteKind::InferenceRs);
pub const UNLOAD_MODEL_ROUTE: RouteInfo =
    RouteInfo::new("/v1/models/unload", "POST", RouteKind::InferenceRs);
...
pub const SYSTEM_INFO_ROUTE: RouteInfo =
    RouteInfo::new("/v1/system/info", "GET", RouteKind::InferenceRs);
...
pub const CALIBRATION_STATUS_ROUTE: RouteInfo =
    RouteInfo::new("/calibration/status", "GET", RouteKind::InferenceRs);
pub const CALIBRATION_APPLY_ROUTE: RouteInfo =
    RouteInfo::new("/calibration/apply", "POST", RouteKind::InferenceRs);
...
pub const INFERENCE_RS_SWAGGER_ROUTES: &[RouteInfo] = &[
...
mod tests {
    ...
    fn route_registry_matches_lora_route_visibility() {
        assert!(INFERENCE_RS_API_ROUTES.contains(&LIST_LORA_ADAPTERS_ROUTE));
        assert!(!INFERENCE_RS_API_ROUTES.contains(&LOAD_LORA_ADAPTER_ROUTE));
        assert!(!INFERENCE_RS_API_ROUTES.contains(&UNLOAD_LORA_ADAPTER_ROUTE));
        assert_eq!(
