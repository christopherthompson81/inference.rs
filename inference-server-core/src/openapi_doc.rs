...
/// The inference.rs server router will include these by default, but if you're
/// including the inference.rs server core into another project, you can generate the
/// OpenAPI docs separately to merge with the other project OpenAPI docs.
///
/// ### Arguments
/// * `base_path` - the base path of the inference.rs server instance (in case the inference.rs server is being included in another axum project)
///
/// ### Example
/// ```ignore
/// // MyApp
...
/// use inference_server_core::openapi_doc::get_openapi_doc;
///
/// #[derive(OpenApi)]
/// #[openapi(
