use inference_mcp::{Function, Tool, ToolType};
use inference_sandbox::{EffectiveProtection, NetworkMode};
use serde_json::json;
use std::collections::HashMap;

use crate::InputModality;

pub const EXECUTE_PYTHON_TOOL_NAME: &str = "inference_execute_python";
pub const RESET_SESSION_TOOL_NAME: &str = "inference_reset_python_session";
pub const READ_FILE_TOOL_NAME: &str = "inference_read_file";
pub const LIST_FILES_TOOL_NAME: &str = "inference_list_files";
pub const SHELL_TOOL_NAME: &str = "inference_shell";
pub const SURFACE_OUTPUTS_TOOL_NAME: &str = "inference_surface_outputs";
        ...
        function: Function {
            description: Some(
                "Surface files that were already created in the shell session working directory. \
                 ...
                 paths into inference.rs's FileStore so the user/API can download them. Call this \
...
pub fn build_read_file_tool() -> Tool {
    ...
    Tool {
        ...
        function: Function {
            description: Some(
                "Read a slice of a text file from inference.rs's internal file store by file id. \
        ...
        function: Function {
            description: Some(
                "List all files available in this session, including uploaded input files and \
                 ...
                 purpose. These ids are for inference_read_file and API/file-store references, not \
