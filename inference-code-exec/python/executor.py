...
# Max size of a declared output file we'll read into memory. Larger files become an error placeholder. Override via INFERENCE_RS_MAX_OUTPUT_BYTES.
MAX_OUTPUT_BYTES = int(
    os.environ.get("INFERENCE_RS_MAX_OUTPUT_BYTES", str(256 * 1024 * 1024))
)
