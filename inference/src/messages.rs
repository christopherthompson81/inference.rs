...
pub trait RequestLike {
    ...
    fn take_shell_options(&mut self) -> Option<inference_core::ShellOptions> {
        None
    }
    fn code_execution_permission(&self) -> Option<inference_core::CodeExecutionPermission> {
        None
    }
    fn agent_permission(&self) -> Option<inference_core::AgentPermission> {
        None
    }
    fn agent_approval_handler(&self) -> Option<inference_core::AgentToolApprovalHandler> {
        None
    }
    ...
    pub fn from_bytes_with_mime(
        ...
        Self {
            file: File::from_bytes(
                ...
                inference_core::FILE_PURPOSE_USER_DATA.to_string(),
                FileSource {
...
pub struct RequestBuilder {
    ...
    enable_shell: bool,
    shell_options: Option<inference_core::ShellOptions>,
    code_execution_permission: Option<inference_core::CodeExecutionPermission>,
    agent_permission: Option<inference_core::AgentPermission>,
    agent_approval_handler: Option<inference_core::AgentToolApprovalHandler>,
...
impl RequestBuilder {
    ...
    pub fn with_shell_options(mut self, options: inference_core::ShellOptions) -> Self {
        self.enable_shell = true;
    ...
    pub fn with_shell_skill(
        ...
        self.enable_shell = true;
        self.shell_options
            .get_or_insert_with(inference_core::ShellOptions::default)
            .skills
            .push(inference_core::ShellSkillMount {
                name: name.into(),
    ...
    pub fn with_agent_approval_callback(
        mut self,
        callback: inference_core::AgentToolApprovalCallback,
    ) -> Self {
        self.agent_approval_handler = Some(inference_core::AgentToolApprovalHandler::from_sync(
            callback,
        ));
        self
    }
    ...
    where
        F: Fn(inference_core::AgentToolApproval) -> Fut + Send + Sync + 'static,
        Fut: Future<Output = inference_core::AgentToolApprovalDecision> + Send + 'static,
    {
        let callback = Arc::new(move |approval| {
            Box::pin(callback(approval)) as inference_core::AgentToolApprovalFuture
        });
        self.agent_approval_handler = Some(inference_core::AgentToolApprovalHandler::from_async(
            callback,
        ));
        self
    }
