...
1. Start the inference.rs server with tool dispatch URL:
   inference serve -p 1234 --tool-dispatch-url http://localhost:8787/tools --max-tool-rounds 5 -m Qwen/Qwen3-4B
...
def main():
    ...
    try:
        ...
        print(
            f"inference serve -p 1234 --tool-dispatch-url http://localhost:{TOOL_SERVER_PORT}/tools "
