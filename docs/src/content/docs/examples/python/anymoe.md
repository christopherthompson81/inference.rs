...
Runnable Python SDK example `anymoe`.
...
Source: [`examples/python/anymoe.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/anymoe.py)
