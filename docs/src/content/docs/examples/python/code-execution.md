---
title: "Python code execution with the OS-level sandbox enabled"
description: "Python code execution with the OS-level sandbox enabled"
sidebar:
...
Source: [`examples/python/code_execution.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/code_execution.py)
