---
title: "Simple test script to verify multi-model functionality in inference.rs"
description: "Simple test script to verify multi-model functionality in inference.rs"
sidebar:
  label: "test_multi_model"
---
