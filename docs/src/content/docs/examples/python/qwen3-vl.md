...
Runnable Python SDK example `qwen3_vl`.
...
Source: [`examples/python/qwen3_vl.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/qwen3_vl.py)
