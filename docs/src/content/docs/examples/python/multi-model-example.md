---
title: "Example demonstrating multi-model usage with inference.rs Python bindings"
description: "Example demonstrating multi-model usage with inference.rs Python bindings"
sidebar:
  label: "multi_model_example"
---
