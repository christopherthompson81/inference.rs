...
Runnable Python SDK example `imatrix`.
...
Source: [`examples/python/imatrix.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/imatrix.py)
