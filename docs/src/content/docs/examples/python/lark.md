...
Runnable Python SDK example `lark`.
...
Source: [`examples/python/lark.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/lark.py)
