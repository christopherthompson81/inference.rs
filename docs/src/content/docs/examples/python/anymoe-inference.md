---
title: "anymoe_inference"
description: "anymoe_inference"
sidebar:
  label: "anymoe_inference"
---

<!-- generated by docs/scripts/render_examples.py; edit the source example instead -->

Runnable Python SDK example `anymoe_inference`.
...
Source: [`examples/python/anymoe_inference.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/anymoe_inference.py)
