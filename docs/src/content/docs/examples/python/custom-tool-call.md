...
description: "custom_tool_call"
sidebar:
  label: "custom_tool_call"
---

<!-- generated by docs/scripts/render_examples.py; edit the source example instead -->

Runnable Python SDK example `custom_tool_call`.
...
Source: [`examples/python/custom_tool_call.py`](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/python/custom_tool_call.py)
