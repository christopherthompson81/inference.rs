---
title: "Example of using SmolLM3 model with inference.rs"
description: "Example of using SmolLM3 model with inference.rs"
sidebar:
  label: "smollm3"
---
...
Source: [`examples/python/smollm3.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/smollm3.py)
