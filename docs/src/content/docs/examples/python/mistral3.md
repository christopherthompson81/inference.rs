...
Runnable Python SDK example `mistral3`.
...
Source: [`examples/python/mistral3.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/python/mistral3.py)
