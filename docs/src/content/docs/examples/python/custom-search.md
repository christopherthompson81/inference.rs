...
Runnable Python SDK example `custom_search`.
...
Source: [`examples/python/custom_search.py`](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/python/custom_search.py)
