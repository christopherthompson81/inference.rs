...
Runnable Python SDK example `phi3v_base64`.
...
Source: [`examples/python/phi3v_base64.py`](https://github.com/EricLBuehler/mistral.rs/blob/master/examples/python/phi3v_base64.py)
