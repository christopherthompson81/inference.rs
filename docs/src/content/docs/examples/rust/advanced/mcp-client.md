---
title: "MCP (Model Context Protocol) client usage with inference.rs"
description: "MCP (Model Context Protocol) client usage with inference.rs"
sidebar:
  label: "mcp_client"
---
...
Source: [`inference/examples/advanced/mcp_client/main.rs`](https://github.com/EricLBuehler/mistral.rs/blob/master/mistralrs/examples/advanced/mcp_client/main.rs)
