---
title: "Concurrent request batching by sending multiple requests in parallel"
description: "Concurrent request batching by sending multiple requests in parallel"
sidebar:
  label: "batching"
---
