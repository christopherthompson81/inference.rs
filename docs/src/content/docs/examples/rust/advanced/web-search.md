---
title: "Web-search-augmented generation using OpenAI-compatible web_search_options"
description: "Web-search-augmented generation using OpenAI-compatible web_search_options"
sidebar:
  label: "web_search"
---
