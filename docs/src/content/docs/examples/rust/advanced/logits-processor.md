---
title: "Custom logits processor that modifies token probabilities during generation"
description: "Custom logits processor that modifies token probabilities during generation"
sidebar:
  label: "logits_processor"
---
