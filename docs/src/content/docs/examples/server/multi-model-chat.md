---
title: "Example demonstrating multi-model usage with inference.rs server HTTP API"
description: "Example demonstrating multi-model usage with inference.rs server HTTP API"
sidebar:
  label: "multi_model_chat"
---
