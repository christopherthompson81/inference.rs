...
Runnable HTTP server example `phi3v_base64`.
...
Source: [`examples/server/phi3v_base64.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/phi3v_base64.py)
