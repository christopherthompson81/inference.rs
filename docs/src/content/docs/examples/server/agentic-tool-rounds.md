---
title: "Example demonstrating server-side agentic loop with max_tool_rounds"
description: "Example demonstrating server-side agentic loop with max_tool_rounds"
sidebar:
  label: "agentic_tool_rounds"
---
