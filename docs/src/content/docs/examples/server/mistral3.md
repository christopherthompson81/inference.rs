...
Runnable HTTP server example `mistral3`.
...
Source: [`examples/server/mistral3.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/mistral3.py)
