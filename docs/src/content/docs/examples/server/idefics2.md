...
Runnable HTTP server example `idefics2`.
...
Source: [`examples/server/idefics2.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/idefics2.py)
