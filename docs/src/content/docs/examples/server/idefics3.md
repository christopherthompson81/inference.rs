...
Runnable HTTP server example `idefics3`.
...
Source: [`examples/server/idefics3.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/idefics3.py)
