---
title: "Example demonstrating tool dispatch URL with inference.rs server-side agentic loop"
description: "Example demonstrating tool dispatch URL with inference.rs server-side agentic loop"
sidebar:
  label: "tool_dispatch"
---
