---
title: "responses_vision"
description: "responses_vision"
sidebar:
  label: "responses_vision"
---

<!-- generated by docs/scripts/render_examples.py; edit the source example instead -->

Runnable HTTP server example `responses_vision`.
...
resp2 = client.responses.create(
    model="default", previous_response_id=resp1.id, input="Can you eat it?"
)
