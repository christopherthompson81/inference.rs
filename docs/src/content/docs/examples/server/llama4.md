...
Runnable HTTP server example `llama4`.
...
Source: [`examples/server/llama4.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/llama4.py)
