...
Runnable HTTP server example `phi3v`.
...
Source: [`examples/server/phi3v.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/phi3v.py)
