...
Runnable HTTP server example `gemma3`.
...
Source: [`examples/server/gemma3.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/gemma3.py)
