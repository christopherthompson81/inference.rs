...
Runnable HTTP server example `llama_vision`.
...
Source: [`examples/server/llama_vision.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/llama_vision.py)
