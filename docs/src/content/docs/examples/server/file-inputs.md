---
title: "OpenAI-compatible file input examples for a local inference.rs server"
description: "OpenAI-compatible file input examples for a local inference.rs server"
sidebar:
  label: "file_inputs"
---
