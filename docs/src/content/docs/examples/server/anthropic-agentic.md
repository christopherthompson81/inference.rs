---
title: "Anthropic-style server tools mapped to inference.rs agentic features"
description: "Anthropic-style server tools mapped to inference.rs agentic features"
sidebar:
  label: "anthropic_agentic"
---
