...
Runnable HTTP server example `gemma3n`.
...
Source: [`examples/server/gemma3n.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/gemma3n.py)
