---
title: "Example of using GPT-OSS model via the HTTP API"
description: "Example of using GPT-OSS model via the HTTP API"
sidebar:
  label: "gpt_oss"
---
...
Source: [`examples/server/gpt_oss.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/gpt_oss.py)
