---
title: "Example demonstrating how to start a inference.rs HTTP server with MCP client support"
description: "Example demonstrating how to start a inference.rs HTTP server with MCP client support"
sidebar:
  label: "mcp_chat"
---
