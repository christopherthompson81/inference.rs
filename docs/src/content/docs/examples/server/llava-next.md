...
Runnable HTTP server example `llava_next`.
...
Source: [`examples/server/llava_next.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/llava_next.py)
