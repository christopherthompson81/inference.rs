---
title: "Basic client-side tool calling with the HTTP API"
description: "Basic client-side tool calling with the HTTP API"
sidebar:
  label: "tool_calling"
---
...
Source: [`examples/server/tool_calling.py`](https://github.com/christopherthompson81/inference.rs/blob/master/examples/server/tool_calling.py)
